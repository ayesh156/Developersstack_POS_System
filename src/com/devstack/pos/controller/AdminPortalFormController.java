...
public class AdminPortalFormController {
    ...
    public void incomeAndReportsOnAction(ActionEvent actionEvent) {
    }
    ...
    public void dealsAndDiscountsOnAction(ActionEvent actionEvent) {
    }

    public void userActivitiesOnAction(ActionEvent actionEvent) {
    }

    public void reportsAndStatisticsOnAction(ActionEvent actionEvent) {
    }
